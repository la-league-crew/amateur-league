...
import com.league.repo.LeagueDeviceRepo;
import com.league.repo.DevicesAndLocationsRepo;
...
@Service
@AllArgsConstructor
public class LeagueDeviceAndLocationServiceImpl implements DeviceAndLocationService {
  private final DevicesAndLocationsRepo devicesAndLocationsRepo;
  private final LeagueDeviceRepo leagueDeviceRepo;
  private final LeagueUserRepo leagueUserRepo;
  private final DatabaseReader databaseReader;
  private final Parser parser;
  private static final String UNKNOWN = "UNKNOWN";

  @Override
  public void verifyDeviceAndLocation(String userName, HttpServletRequest request)
    ...
    LeagueUser leagueUser = leagueUserRepo.findByEmail(userName).get();
    devicesAndLocationsRepo
        .findByLeagueUser(leagueUser)
        .ifPresentOrElse(
            devices -> {
                  ...
                  .ifPresentOrElse(
                      ...
                      () -> {
                        ...
                        DevicesAndLocations userDevicesAndLocations =
                            devicesAndLocationsRepo.findByLeagueUser(leagueUser).get();
